...
#include <slamtool/geometry/stereo.h>
#include <slamtool/map/track.h>
#include <slamtool/map/frame.h>

#include <slamtool/estimation/reprojection_factor.h>

namespace slamtool{

class TinyReprojectionErrorFactor: public ReprojectionErrorFactor{
...
class TinyReprojectionPriorFactor : public ReprojectionPriorFactor{
public:
    TinyReprojectionPriorFactor(Frame *frame, Track *track):rpefactor(frame, track) {}
    TinyReprojectionErrorFactor rpefactor;
};
